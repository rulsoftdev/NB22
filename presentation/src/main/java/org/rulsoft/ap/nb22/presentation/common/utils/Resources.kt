...
fun onResourceReady(context: Context, resource: Bitmap, applicationId: String) {
    ...
    val contentUri: Uri = FileProvider.getUriForFile(context, "$applicationId.provider", newFile)
